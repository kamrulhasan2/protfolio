...
export default function IntroSection() {
  ...
  return (
    <div
      id="home"
      className="w-full flex flex-col-reverse lg:flex-row gap-14 justify-between items-center relative z-50"
    >
      <div className="flex flex-col gap-6 w-full">
        ...
        <p className="text-base text-gray-800 dark:text-gray-300">
          My technical expertise is centered on the full MERN stack. I leverage
          React.js and Next.js to craft responsive, high-performance user
          interfaces, and use Node.js with Express.js to architect scalable
          back-end systems and secure RESTful APIs. With a solid foundation in
          database management using MongoDB and MySQL, I am equipped to handle
        ...
        <div className="flex gap-4">
          ...
          <Link
            href={"https://www.linkedin.com/in/kamrul-hasan-a2935017a/"}
            target="_blank"
          >
            <Linkedin />
          </Link>
